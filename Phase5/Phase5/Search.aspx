    ...
    <div>
        <table border ="1" >
            <tr>
                ...
                <td><asp:Label ID="Label2" runat="server" Text="Business Name: "></asp:Label><asp:TextBox ID="txtBusinessName" runat="server" Width="300px"></asp:TextBox> </td>
            </tr>
            <tr>
                <td>
                ...
                <td><asp:Label ID="Label4" runat="server" Text="City: "></asp:Label>
                    <asp:DropDownList ID="ddlCity" runat="server" DataSourceID="SqlDataSource2" DataTextField="City" DataValueField="City" AppendDataBoundItems="true">
                        <asp:ListItem Text="-Select-" Value="" />    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
